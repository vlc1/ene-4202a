...
1. Commenter l'allure des courbes.
...
2. Utiliser la fonction `ordernum` implémentée ci-dessous pour estimer l'ordre des méthodes `explicit!`, `implicit!`, `midpoint!`, `rk2!` et `rk3!`.
...
# ╔═╡ 41bf691c-d89b-4674-bdca-a135414e7aba
ordernum.(Ref(τs), values(ϵs))
